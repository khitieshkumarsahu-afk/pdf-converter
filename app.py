    ...
    <div class="container">
        <div class="card p-5">
            ...
            <div id="dropZone">
                ...
                <input type="file" id="fileInput" class="d-none" name="files" accept="application/pdf" multiple required>
            </div>
            <br>

            <!-- Format Selector -->
            <form id="uploadForm" action="/convert" method="post" enctype="multipart/form-data" class="text-center">
                <input type="hidden" id="hiddenFileInput" name="files">
                <div class="mb-3">
    ...
    <script>
        ...
        form.onsubmit = function(e) {
            ...
            xhr.onloadstart = function() {
                status.innerHTML = "⏳ Uploading & Converting...";
